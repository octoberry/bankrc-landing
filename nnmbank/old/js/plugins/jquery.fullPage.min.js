...
(function (a) {
    a.fn.fullpage = function (c) {
        ...
        function M() {
            if (!c.autoScrolling) {
                ...
                if (!d.hasClass("active")) {
                    D = !0;
                    var e = a(".fp-section.active").index(".fp-section") + 1, f = E(d), h = d.data("anchor");
        ...
        function x(b, d) {
            if ("down" == b)
                var c = "bottom", f = a.fn.fullpage.moveSectionDown;
            else
                c = "top", f = a.fn.fullpage.moveSectionUp;
            if (0 < d.length)
                if (c = "top" === c ? !d.scrollTop() : "bottom" === c ? d.scrollTop() +
                        1 + d.innerHeight() >= d[0].scrollHeight : void 0, c)
                    f();
                else
                    return!0;
            else
        ...
        function m(b) {
            if (c.autoScrolling) {
                ...
                var d = a(".fp-section.active"), d = O(d);
        ...
        function r(b, d, e) {
            ...
            if ("undefined" !== typeof h) {
                var h = h.top, A = E(b), g = b.data("anchor"), l = b.index(".fp-section"), k = b.find(".fp-slide.active"), B = a(".fp-section.active"), t = B.index(".fp-section") + 1, m = C;
                if (k.length)
                    var p =
                            k.data("anchor"), r = k.index();
                if (c.autoScrolling && c.continuousVertical && "undefined" !== typeof e && (!e && "up" == A || e && "down" == A)) {
                    ...
                    S();
                    var n = B, h = b.position(), h = h.top, A = E(b)
                }
        ...
        function V() {
            if (!D) {
                ...
                if (a.length) {
                    var c = "undefined" === typeof v, f = "undefined" === typeof v && "undefined" === typeof b && !t;
        ...
        function p(b, d) {
            ...
            var before = function () {
                q || a.isFunction(c.beforeSlideLoad) && c.beforeSlideLoad.call(this, k, l + 1, m, h);
                t = !1
            };
            before();
        ...
        function w(b) {
            ...
            if (e.length)
                ...
                f = b.get(0).scrollHeight, c.verticalCentered && (f = b.find(".fp-tableCell").get(0).scrollHeight);
            a = k - parseInt(a.css("padding-bottom")) - parseInt(a.css("padding-top"));
            f > a ? e.length ? e.css("height", a + "px").parent().css("height", a + "px") : (c.verticalCentered ? b.find(".fp-tableCell").wrapInner('<div class="fp-scrollable" />') : b.wrapInner('<div class="fp-scrollable" />'), b.find(".fp-scrollable").slimScroll({allowPageScroll: !0, height: a + "px",
                size: "10px", alwaysVisible: !0})) : Z(b);
            b.css("overflow", "")
        }
        function Z(b) {
        ...
        function aa(b) {
            ...
            if (c.paddingTop || c.paddingBottom)
                a = b, a.hasClass("fp-section") || (a = b.closest(".fp-section")), b = parseInt(a.css("padding-top")) + parseInt(a.css("padding-bottom")), a = k - b;
            return a
        }
        function U(b, a) {
        ...
        function ja() {
            var a = document.createElement("p"), c, e = {webkitTransform: "-webkit-transform", OTransform: "-o-transform", msTransform: "-ms-transform",
                MozTransform: "-moz-transform", transform: "transform"};
            document.body.insertBefore(a, null);
            for (var f in e)
                void 0 !== a.style[f] && (a.style[f] = "translate3d(1px,1px,1px)", c = window.getComputedStyle(a).getPropertyValue(e[f]));
        ...
        c = a.extend({verticalCentered: !0, resize: !0, sectionsColor: [], anchors: [], scrollingSpeed: 700, easing: "easeInQuart", menu: !1, navigation: !1,
            ...
            afterResize: null, beforeSlideLoad: null, afterSlideLoad: null, onSlideLeave: null}, c);
        ...
        a.fn.fullpage.setAutoScrolling = function (b) {
            c.autoScrolling = b;
            b = a(".fp-section.active");
            c.autoScrolling ? (a("html, body").css({overflow: "hidden", height: "100%"}), g.css({"-ms-touch-action": "none", "touch-action": "none"}), b.length && s(b.position().top)) :
                    (a("html, body").css({overflow: "visible", height: "initial"}), g.css({"-ms-touch-action": "", "touch-action": ""}), s(0), a("html, body").scrollTop(b.position().top))
        };
        ...
        a.fn.fullpage.setAllowScrolling = function (b) {
            if (b) {
                if (a.fn.fullpage.setMouseWheelScrolling(!0), K || da)
                    MSPointer = ca(), a(document).off("touchstart " + MSPointer.down).on("touchstart " + MSPointer.down, ga), a(document).off("touchmove " + MSPointer.move).on("touchmove " + MSPointer.move, fa)
            } else if (a.fn.fullpage.setMouseWheelScrolling(!1), K || da)
                MSPointer = ca(), a(document).off("touchstart " + MSPointer.down), a(document).off("touchmove " +
                        MSPointer.move)
        };
        ...
        var t = !1,
                ...
                l;
        //weblime
        if (a("#border-page").length){
            var k = a(window).height() - (parseInt(a("#border-page").css("border-top-width").replace("px", "")) * 2) - (parseInt(a("#border-page-inner").css("border-top-width").replace("px", "")) * 2);
        } else {
            var k = a(window).height()
        }
        a.fn.fullpage.setAllowScrolling(!0);
        c.css3 && (c.css3 = ja());
        a(this).length ? (g.css({height: "100%", position: "relative"}), g.addClass("fullpage-wrapper")) : console.error("Error! Fullpage.js needs to be initialized with a selector. For example: $('#myContainer').fullpage();");
        ...
        a(".fp-section").each(function (b) {
            ...
            a(window).on("load", function () {
                var a =
                        window.location.hash.replace("#", "").split("/"), b = a[0], a = a[1];
                b && J(b, a)
            })
        });
        var N, D = !1;
        ...
        a(document).on("click touchstart", "*[data-go-slide=yes]", function (b) {
            b.preventDefault();
            b = a(this).attr("data-slide");
            r(a(".fp-section").eq(b-1));
        });
        ...
        a(".toSlide").on("click", function (b) {
            b.preventDefault();
            //b = a(this).closest(".fp-section").find(".fp-slides");
            //weblime
            b = a(".section.active").find(".fp-slides");
        ...
        a.fn.fullpage.reBuild = function () {
            ...
            //weblime
            if (a("#border-page").length){
                k = a(window).height() - (parseInt(a("#border-page").css("border-top-width").replace("px", "")) * 2) - (parseInt(a("#border-page-inner").css("border-top-width").replace("px", "")) * 2);
            } else {
                k = a(window).height()
            }
            c.resize && ha(k, b);
